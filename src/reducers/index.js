...
export function posts(state = null, action) {
  ...
  switch(action.type) {
    ...
    case ADD_POST:
      new_state[action.id] = {};
      new_state[action.id].id = action.id;
      new_state[action.id].author = action.author;
      new_state[action.id].title = action.title;
      new_state[action.id].body = action.body;
      new_state[action.id].timestamp = action.timestamp;
      new_state[action.id].category = action.category;
      new_state[action.id].deleted = action.deleted;
      new_state[action.id].voteScore = action.voteScore;
      return new_state
